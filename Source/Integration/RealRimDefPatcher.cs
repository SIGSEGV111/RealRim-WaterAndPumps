...
namespace RealRim.WaterAndPumps
{
	...
	internal static class RealRimDefPatcher
	{
		...
		private static void applyDefinitions()
		{
			...
			if (failed_phases == 0)
			{
				Log.Message("[RealRim] Water & Pumps 1.1.65: replaced DBH water, heating, cooling, sprinkler and sewage definitions.");
			}
			else
			{
				Log.Error("[RealRim] Water & Pumps 1.1.65: definition replacement completed with "
